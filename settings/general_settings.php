...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_trema', 'preset', 0, 'itemid, filepath, filename', false);
...
$title = get_string('presetfiles','theme_trema');
$description = get_string('presetfiles_desc', 'theme_trema');
